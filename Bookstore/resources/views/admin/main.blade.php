...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('images') }}/logo_FA.png">
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="{{ asset('admin') }}/assets/images/admin-logo.png" alt="">
